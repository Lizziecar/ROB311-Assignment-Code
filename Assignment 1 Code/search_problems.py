...
class Node:
    ...
    def __init__(self, parent, state, action, path_cost): # set up node
        self.parent = parent
        self.state = state
        self.action = action
        self.path_cost = path_cost

    def __lt__(self, other): # compare path cost (less than)
        return self.path_cost < other.path_cost

    def __eq__(self, other): # compare path cost and state (equal)
...
class SearchProblem(ABC):
    ...
    """
    def __init__(self, goal_states, init_state): # set goal state and initial states
    ...
    def trace_path(self, node, target_state=None): # trace out path
